...
namespace VersionOne.ServiceHost.ConfigurationTool {
    ...
    public class ServicesMap {
        ...
        public static readonly ServicesMap ClearQuestService = new ServicesMap(
            typeof(ClearQuestServiceEntity),
            "VersionOne.ServiceHost.ClearQuestServices.ClearQuestHostedService",
            "VersionOne.ServiceHost.ClearQuestServices.ClearQuestHostedService+IntervalSync",
            "VersionOne.ServiceHost.ClearQuestServices"); 
